  ...
  return (
    <div className="grid gap-3 md:grid-cols-3">
      {order.map((entry) => (
        ...
        >
          <div className="theme-shell-pill theme-shell-muted mx-auto flex w-fit items-center gap-2 rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em]">
          ...
          <p className="theme-shell-muted text-sm"><span className="retro-numeric">{entry.completedWins}</span> completed wins</p>
